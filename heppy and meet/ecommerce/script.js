...
//             <img src="${x.img}" alt="Product Image 1">
//             <img src="${x.img2}" alt="Product Image 2">

//         </div>
//         <div class="product-details">
//             <h2 class="product-title">${x.title}</h2>
//             <p class="product-category">Category: Earbud</p>
...
// `
// }).join('')
// wrapper2.innerHTML = tshirt.map((x) => {
//     return `
//     <div class="product-card">
//         <div class="product-img">
//             <img src="${x.img}" alt="Product Image 1">
